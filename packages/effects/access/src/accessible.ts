...
import { cloneDeep, generateMenus, generateRoutesByBackend, generateRoutesByFrontend, isFunction, isString, mapTree } from '@vben/utils';
...
async function generateRoutes(mode: AccessModeType, options: GenerateMenuAndRoutesOptions) {
  ...
  resultRoutes = mapTree(resultRoutes, (route) => {
    ...
    if (keepAlive.value && isFunction(route.component) && route.name && isString(route.name)) {
