...
<template>
  <div class="flex w-full flex-wrap justify-between">
    ...
    <SwitchItem v-model="themeSemiDarkSidebar" :disabled="modelValue === 'dark'" class="mt-6" v-if="false">
      {{ $t('preferences.theme.darkSidebar') }}
    </SwitchItem>
    <SwitchItem v-model="themeSemiDarkHeader" :disabled="modelValue === 'dark'" v-if="false">
