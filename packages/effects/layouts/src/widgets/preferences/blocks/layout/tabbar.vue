...
<template>
  <SwitchItem v-model="tabbarEnable" :disabled="disabled" v-if="false">
  ...
  <SwitchItem v-model="tabbarShowMore" :disabled="!tabbarEnable" v-if="false">
    {{ $t('preferences.tabbar.showMore') }}
  </SwitchItem>
  <SwitchItem v-model="tabbarShowMaximize" :disabled="!tabbarEnable" v-if="false">
