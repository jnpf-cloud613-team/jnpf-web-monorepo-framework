...
<template>
  <div>
    <Modal :fullscreen-button="false" class="w-[600px]" header-class="py-2 border-b">
      ...
      <template #footer>
        <div class="flex w-full justify-start py-2 text-xs">
          <div class="mr-3 flex items-center">
            <CornerDownLeft class="mr-1 size-4" />
          ...
          <div class="flex items-center">
            <MdiKeyboardEsc class="mr-1 size-4" />
    ...
    <div
      class="md:bg-accent global-search group flex h-8 cursor-pointer items-center gap-3 rounded-2xl border-none bg-none px-2 py-0.5 outline-none"
      @click="toggleOpen()">
