  ...
  <aside
    :class="[
      theme,
      {
        ...
        'bg-sidebar border-border': !isSidebarMixed,
        'is-mobile': !domVisible,
      },
    ]"
    :style="style"
    ...
    <div
      ...
      ref="asideRef"
      :class="{
        'border-border-opacity border-l': extraVisible,
        'bg-background': !expandOnHover,
      }"
      :style="extraStyle"
      class="border-border fixed top-0 h-full overflow-hidden transition-all duration-200">
...
<style lang="scss">
.light.bg-sidebar:not(.is-mobile) {
  ...
  .jnpf-menu-item.is-active {
    background: rgb(255 255 255 / 40%);
  }
}

.light.bg-sidebar-deep {
  background: transparent;
