...
/* istanbul ignore next */
export function on(element: Document | Element | HTMLElement | Window, event: string, handler: EventListenerOrEventListenerObject): void {
...
/* istanbul ignore next */
export function off(element: Document | Element | HTMLElement | Window, event: string, handler: Fn): void {
  if (element && event && handler) {
