...
export default class Color {
  ...
  doOnChange() {
    const { _alpha, _hue, _saturation, _value, format } = this;
    ...
    if (this.enableAlpha) {
      switch (format) {
        ...
        case 'hsl': {
          const hsl: any = hsv2hsl(_hue, _saturation / 100, _value / 100);
        ...
        default: {
          const { b, g, r } = hsv2rgb(_hue, _saturation, _value);
  ...
  set(prop: any | { [key: string]: any }, value?: number) {
